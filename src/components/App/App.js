  ...
  function handleMovieSave(movie) {
    mainApi
      .postMovie(
        ...
        movie.image.url ? 'https://api.nomoreparties.co/beatfilm-movies' + movie.image.url : src,
        movie.trailerLink ||
        ...
        movie.image.formats.thumbnail.url
          ? 'https://api.nomoreparties.co/beatfilm-movies' + movie.image.formats.thumbnail.url
          : src,
        movie.id,
